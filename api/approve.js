export default async function handler(req, res) {
  // Izinkan Cross-Origin (CORS) dari Pi Browser
  ...
  try {
    ...
    if (!API_KEY) {
      console.error("PI_API_KEY tidak ditemukan di environment variables");
    ...
    if (!piRes.ok) {
      console.error("Pi Testnet Approval Failed:", data);
